...
/*************************************************************************************
* 此项目仅用于演示 Union 库的部分和模块的用法，请勿将其用于生产环境
* 本项目涉及的 Union 库模块包括但不限于：
*   archivist: simple_memory_table, single_loader
*   labourer: ThreadLake, background
*   secretary: PrintCenter, log, logger
*   utilities
* *************************************************************************************/
